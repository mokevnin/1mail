...
func (TrackingProfile) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("subject_id", "workspace_id").Unique().StorageKey("tracking_profiles_subject_id_workspace_id"),
		index.Fields("email", "workspace_id").Unique().StorageKey("tracking_profiles_email_workspace_id"),
		index.Fields("phone", "workspace_id").Unique().StorageKey("tracking_profiles_phone_workspace_id"),
	}
}
