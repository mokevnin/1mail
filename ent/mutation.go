...
func (m *InvitationMutation) SetID(id int64) {
	m.id = &id
}
...
// SetWorkspaceID sets the "workspace_id" field.
func (m *InvitationMutation) SetWorkspaceID(i int64) {
	m.workspace = &i
}

// WorkspaceID returns the value of the "workspace_id" field in the mutation.
func (m *InvitationMutation) WorkspaceID() (r int64, exists bool) {
	v := m.workspace
	if v == nil {
		return
	}
...
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *InvitationMutation) OldWorkspaceID(ctx context.Context) (v int64, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldWorkspaceID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
func (m *InvitationMutation) SetInvitedBy(i int64) {
	m.inviter = &i
}

// InvitedBy returns the value of the "invited_by" field in the mutation.
func (m *InvitationMutation) InvitedBy() (r int64, exists bool) {
	v := m.inviter
	if v == nil {
		return
	}
...
// If the Invitation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *InvitationMutation) OldInvitedBy(ctx context.Context) (v *int64, err error) {
	if !m.op.Is(OpUpdateOne) {
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// WorkspaceID instead. It exists only for internal usage by the builders.
func (m *InvitationMutation) WorkspaceIDs() (ids []int64) {
	if id := m.workspace; id != nil {
		ids = append(ids, *id)
	}
	return
...
func (m *InvitationMutation) SetInviterID(id int64) {
	m.inviter = &id
}
...
func (m *InvitationMutation) InviterID() (id int64, exists bool) {
	if m.inviter != nil {
...
func withMembershipID(id int64) membershipOption {
...
func (m *MembershipMutation) SetID(id int64) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *MembershipMutation) ID() (id int64, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *MembershipMutation) IDs(ctx context.Context) ([]int64, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
...
func (m *MembershipMutation) ClearWorkspace() {
	m.clearedworkspace = true
	m.clearedFields[membership.FieldWorkspaceID] = struct{}{}
}

// WorkspaceCleared reports if the "workspace" edge to the Workspace entity was cleared.
func (m *MembershipMutation) WorkspaceCleared() bool {
	return m.clearedworkspace
}
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// WorkspaceID instead. It exists only for internal usage by the builders.
func (m *MembershipMutation) WorkspaceIDs() (ids []int64) {
	if id := m.workspace; id != nil {
		ids = append(ids, *id)
	}
	return
...
func (m *UserMutation) RemoveMembershipIDs(ids ...int64) {
...
func (m *UserMutation) RemovedMembershipsIDs() (ids []int64) {
...
func (m *UserMutation) MembershipsIDs() (ids []int64) {
...
// AddMembershipIDs adds the "memberships" edge to the Membership entity by ids.
func (m *WorkspaceMutation) AddMembershipIDs(ids ...int64) {
	if m.memberships == nil {
		m.memberships = make(map[int64]struct{})
	}
	for i := range ids {
...
// ClearMemberships clears the "memberships" edge to the Membership entity.
func (m *WorkspaceMutation) ClearMemberships() {
	m.clearedmemberships = true
}

// MembershipsCleared reports if the "memberships" edge to the Membership entity was cleared.
func (m *WorkspaceMutation) MembershipsCleared() bool {
	return m.clearedmemberships
}

// RemoveMembershipIDs removes the "memberships" edge to the Membership entity by IDs.
func (m *WorkspaceMutation) RemoveMembershipIDs(ids ...int64) {
	if m.removedmemberships == nil {
		m.removedmemberships = make(map[int64]struct{})
	}
	for i := range ids {
...
// RemovedMemberships returns the removed IDs of the "memberships" edge to the Membership entity.
func (m *WorkspaceMutation) RemovedMembershipsIDs() (ids []int64) {
	for id := range m.removedmemberships {
		ids = append(ids, id)
	}
	return
...
// MembershipsIDs returns the "memberships" edge IDs in the mutation.
func (m *WorkspaceMutation) MembershipsIDs() (ids []int64) {
	for id := range m.memberships {
		ids = append(ids, id)
	}
	return
...
// ResetMemberships resets all changes to the "memberships" edge.
func (m *WorkspaceMutation) ResetMemberships() {
	m.memberships = nil
	m.clearedmemberships = false
	m.removedmemberships = nil
}
...
func (m *WorkspaceMutation) AddInvitationIDs(ids ...int64) {
...
func (m *WorkspaceMutation) RemoveInvitationIDs(ids ...int64) {
...
func (m *WorkspaceMutation) RemovedInvitationsIDs() (ids []int64) {
...
func (m *WorkspaceMutation) InvitationsIDs() (ids []int64) {
