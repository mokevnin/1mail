...
func (_q *EventQuery) QueryWorkspace() *WorkspaceQuery {
...
func (_q *EventQuery) WithWorkspace(opts ...func(*WorkspaceQuery)) *EventQuery {
	query := (&WorkspaceClient{config: _q.config}).Query()
...
func (_q *EventQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Event, error) {
	...
	if query := _q.withWorkspace; query != nil {
		if err := _q.loadWorkspace(ctx, query, nodes, nil,
			func(n *Event, e *Workspace) { n.Edges.Workspace = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *EventQuery) loadWorkspace(ctx context.Context, query *WorkspaceQuery, nodes []*Event, init func(*Event), assign func(*Event, *Workspace)) error {
...
func (_q *EventQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withWorkspace != nil {
			_spec.Node.AddColumnOnce(event.FieldWorkspaceID)
		}
	}
