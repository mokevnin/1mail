...
func (_q *MembershipQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *MembershipQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *MembershipQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *MembershipQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *MembershipQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *MembershipQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *MembershipQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(membership.Table, membership.Columns, sqlgraph.NewFieldSpec(membership.FieldID, field.TypeInt64))
	_spec.From = _q.sql
