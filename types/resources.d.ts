...
export default interface Resources {
  "translation": {
    "acceptInvitation": {
      ...
      "successMessage": "You've joined the workspace. Please sign in.",
    ...
    "automations": {
      ...
      "branchesUnsupported": "Only a single linear path is saved. Nodes off the main chain were ignored.",
      "branchesUnsupportedTitle": "Branches not supported yet",
      "createTitle": "New automation",
      "deactivate": "Deactivate",
      "editTitle": "Edit automation",
      "emailBodyHint": "MJML markup. Use merge tags like {{first_name}}.",
      "emailBodyLabel": "Email body",
      "emailNodeDescription": "Send an email to the contact.",
      "emailSubjectLabel": "Subject",
      "emptyState": "Create your first automation.",
      "nameLabel": "Name",
      "noRecords": "No automations yet",
      "statusActive": "Active",
      "statusDraft": "Draft",
      "statusLabel": "Status",
      ...
      "triggerEmailClicked": "Email clicked",
      "triggerEmailOpened": "Email opened",
      "triggerEmailUnsubscribed": "Email unsubscribed",
      "triggerHint": "The event that enrolls a contact into this automation.",
      "triggerLabel": "Trigger event",
      "waitNodeDescription": "Pause before the next step.",
      "waitSecondsLabel": "Wait (seconds)"
    },
    "broadcasts": {
    ...
    "notifications": {
      ...
      "automationDeactivated": "Automation deactivated",
      ...
      "broadcastSent": "Broadcast is sending",
    ...
    "settings": {
      ...
      "integrations": {
        ...
        "createError": "Failed to save provider",
        "default": "Default",
        "delete": "Delete",
        "deleteConfirmDescription": "This workspace will no longer be able to send through it.",
        "deleteConfirmTitle": "Delete provider?",
        "deleteError": "Failed to delete provider",
        "description": "Connect an email provider so this workspace can send mail.",
        "empty": "No providers connected yet",
        "enabled": "Enabled",
        "fields": {
        ...
        "secretKept": "Leave blank to keep the stored secret",
      ...
      "members": {
        ...
        "inviteUrlNotice": "Copy this invite link — you can also share it directly.",
        "loadError": "Failed to load members",
        "membersEmpty": "No members yet",
        "membersTitle": "Members",
        "nameHeader": "Name",
        "remove": "Remove",
        "removeConfirmDescription": "They will immediately lose access to this workspace.",
        "removeConfirmTitle": "Remove member?",
        "removeError": "Failed to remove member",
        "revoke": "Revoke",
        "revokeConfirmDescription": "The invite link will stop working.",
      ...
      "sendingDomains": {
        "create": "Add domain",
        "createError": "Failed to add domain",
        "delete": "Delete",
        ...
        "dmarcHint": "Bulk senders to Gmail/Yahoo need at least a p=none record.",
        "domainLabel": "Domain",
        "empty": "No sending domains yet",
        "loadError": "Failed to load sending domains",
        "pending": "Pending",
        "recordHost": "Host",
        "recordName": "Record",
        "recordType": "Type",
        "recordValue": "Value",
        "recordsHint": "Add these TXT records at your DNS provider, then click Verify.",
        "saved": "Domain added",
        "spf": "SPF (recommended)",
        "spfHint": "Advisory — does not gate sending.",
        "statusColumn": "Status",
        "title": "Sending domains",
        "verified": "Verified",
        "verify": "Verify",
        "verifyError": "Failed to start verification",
        "verifyQueued": "Verification started"
      },
      "sesWebhook": {
        "description": "Register this URL as the HTTPS subscription for your SES bounce and complaint SNS topic. Bounced and complained addresses are added to the suppression list automatically.",
        "title": "SES bounce & complaint webhook"
      },
      "suppressions": {
        "create": "Suppress",
        "createError": "Failed to suppress address",
        "delete": "Remove",
        "deleteConfirmTitle": "Remove this address from the suppression list?",
        "deleteError": "Failed to remove suppression",
        "emailColumn": "Email",
        "emailHint": "Sends to this address will be skipped",
        "emailLabel": "Email address",
        "empty": "No suppressed addresses",
        "loadError": "Failed to load suppression list",
        "reasonColumn": "Reason",
        "reasons": {
          "bounce": "Bounced",
          "complaint": "Complaint",
