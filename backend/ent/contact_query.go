...
func (_q *ContactQuery) QueryProject() *ProjectQuery {
...
func (_q *ContactQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *ContactQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *ContactQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *ContactQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *ContactQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *ContactQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ContactQuery) WithProject(opts ...func(*ProjectQuery)) *ContactQuery {
	query := (&ProjectClient{config: _q.config}).Query()
...
func (_q *ContactQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Contact, error) {
	...
	if query := _q.withProject; query != nil {
		if err := _q.loadProject(ctx, query, nodes, nil,
			func(n *Contact, e *Project) { n.Edges.Project = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ContactQuery) loadProject(ctx context.Context, query *ProjectQuery, nodes []*Contact, init func(*Contact), assign func(*Contact, *Project)) error {
...
func (_q *ContactQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(contact.Table, contact.Columns, sqlgraph.NewFieldSpec(contact.FieldID, field.TypeInt64))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withProject != nil {
			_spec.Node.AddColumnOnce(contact.FieldWorkspaceProjectID)
		}
	}
