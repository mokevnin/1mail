...
type UserQuery struct {
	...
	withWorkspaceMemberships *WorkspaceMembershipQuery
...
func (_q *UserQuery) QueryWorkspaceMemberships() *WorkspaceMembershipQuery {
...
func (_q *UserQuery) WithWorkspaceMemberships(opts ...func(*WorkspaceMembershipQuery)) *UserQuery {
	query := (&WorkspaceMembershipClient{config: _q.config}).Query()
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withWorkspaceMemberships; query != nil {
		if err := _q.loadWorkspaceMemberships(ctx, query, nodes,
			func(n *User) { n.Edges.WorkspaceMemberships = []*WorkspaceMembership{} },
			func(n *User, e *WorkspaceMembership) {
...
func (_q *UserQuery) loadWorkspaceMemberships(ctx context.Context, query *WorkspaceMembershipQuery, nodes []*User, init func(*User), assign func(*User, *WorkspaceMembership)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(workspacemembership.FieldUserID)
	}
