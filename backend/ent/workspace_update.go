...
// AddMemberships adds the "memberships" edges to the WorkspaceMembership entity.
func (_u *WorkspaceUpdate) AddMemberships(v ...*WorkspaceMembership) *WorkspaceUpdate {
...
// ClearMemberships clears all "memberships" edges to the WorkspaceMembership entity.
func (_u *WorkspaceUpdate) ClearMemberships() *WorkspaceUpdate {
	_u.mutation.ClearMemberships()
	return _u
}

// RemoveMembershipIDs removes the "memberships" edge to WorkspaceMembership entities by IDs.
func (_u *WorkspaceUpdate) RemoveMembershipIDs(ids ...int64) *WorkspaceUpdate {
	_u.mutation.RemoveMembershipIDs(ids...)
	return _u
}

// RemoveMemberships removes "memberships" edges to WorkspaceMembership entities.
func (_u *WorkspaceUpdate) RemoveMemberships(v ...*WorkspaceMembership) *WorkspaceUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddMemberships adds the "memberships" edges to the WorkspaceMembership entity.
func (_u *WorkspaceUpdateOne) AddMemberships(v ...*WorkspaceMembership) *WorkspaceUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// RemoveMemberships removes "memberships" edges to WorkspaceMembership entities.
func (_u *WorkspaceUpdateOne) RemoveMemberships(v ...*WorkspaceMembership) *WorkspaceUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
