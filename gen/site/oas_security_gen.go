...
var operationRolesApiKeyAuth = map[string][]string{
	...
	SiteAutomationsDeleteOperation:       []string{},
	SiteAutomationsGetOperation:          []string{},
	SiteAutomationsListOperation:         []string{},
	SiteAutomationsUpdateOperation:       []string{},
	...
	SiteBroadcastsTestSendOperation:      []string{},
	...
	SiteCustomFieldsListOperation:        []string{},
	...
	SiteInvitationsCreateOperation:       []string{},
	SiteInvitationsDeleteOperation:       []string{},
	...
	SiteSendingDomainsCreateOperation:    []string{},
	SiteSendingDomainsDeleteOperation:    []string{},
	SiteSendingDomainsGetOperation:       []string{},
	SiteSendingDomainsListOperation:      []string{},
	SiteSendingDomainsVerifyOperation:    []string{},
	SiteSuppressionsCreateOperation:      []string{},
	SiteSuppressionsDeleteOperation:      []string{},
	SiteSuppressionsListOperation:        []string{},
	SiteTemplatesCreateOperation:         []string{},
	SiteTemplatesDeleteOperation:         []string{},
	SiteTemplatesGetOperation:            []string{},
	SiteTemplatesListOperation:           []string{},
	SiteTemplatesUpdateOperation:         []string{},
	SiteTokensCreateOperation:            []string{},
	SiteTokensDeleteOperation:            []string{},
	SiteTokensListOperation:              []string{},
	SiteTransactionalEmailsListOperation: []string{},
