		...
		case '/': // Prefix: "/"
			...
			case 'i': // Prefix: "invitations/"
				...
				if len(elem) == 0 {
					switch r.Method {
					case "GET":
						s.handleSitePublicInvitationsLookupRequest([1]string{
							args[0],
						}, elemIsEscaped, w, r)
					default:
						s.notAllowed(w, r, notAllowedParams{
				...
				case '/': // Prefix: "/accept"
					...
					if len(elem) == 0 {
						...
						switch r.Method {
						case "POST":
							s.handleSitePublicInvitationsAcceptRequest([1]string{
								args[0],
							}, elemIsEscaped, w, r)
						default:
							s.notAllowed(w, r, notAllowedParams{
					...
					case '/': // Prefix: "/"
						...
						case 'i': // Prefix: "in"
							...
							case 'v': // Prefix: "vitations"
								...
								if len(elem) == 0 {
									switch r.Method {
									case "GET":
										s.handleSiteInvitationsListRequest([1]string{
											args[0],
										}, elemIsEscaped, w, r)
									case "POST":
										s.handleSiteInvitationsCreateRequest([1]string{
											args[0],
										}, elemIsEscaped, w, r)
									default:
										s.notAllowed(w, r, notAllowedParams{
								...
								case '/': // Prefix: "/"
									...
									if len(elem) == 0 {
										...
										switch r.Method {
										case "DELETE":
											s.handleSiteInvitationsDeleteRequest([2]string{
												args[0],
												args[1],
											}, elemIsEscaped, w, r)
										default:
						...
						case 'm': // Prefix: "memberships"
							...
							if len(elem) == 0 {
								switch r.Method {
								case "GET":
									s.handleSiteMembershipsListRequest([1]string{
										args[0],
									}, elemIsEscaped, w, r)
								default:
									s.notAllowed(w, r, notAllowedParams{
							...
							case '/': // Prefix: "/"
								...
								if len(elem) == 0 {
									...
									case "PUT":
										s.handleSiteMembershipsUpdateRequest([2]string{
											args[0],
											args[1],
										}, elemIsEscaped, w, r)
									default:
		...
		case '/': // Prefix: "/"
			...
			case 'i': // Prefix: "invitations/"
				...
				if len(elem) == 0 {
					switch method {
					case "GET":
						r.name = SitePublicInvitationsLookupOperation
						r.summary = ""
						r.operationID = "SitePublicInvitations_lookup"
						r.operationGroup = ""
				...
				case '/': // Prefix: "/accept"
					...
					if len(elem) == 0 {
						...
						switch method {
						case "POST":
							r.name = SitePublicInvitationsAcceptOperation
							r.summary = ""
							r.operationID = "SitePublicInvitations_accept"
							r.operationGroup = ""
					...
					case '/': // Prefix: "/"
						...
						case 'i': // Prefix: "in"
							...
							case 'v': // Prefix: "vitations"
								...
								if len(elem) == 0 {
									switch method {
									case "GET":
										r.name = SiteInvitationsListOperation
										r.summary = ""
										r.operationID = "SiteInvitations_list"
										r.operationGroup = ""
										r.pathPattern = "/workspaces/{slug}/invitations"
										r.args = args
										r.count = 1
										return r, true
									case "POST":
										r.name = SiteInvitationsCreateOperation
										r.summary = ""
										r.operationID = "SiteInvitations_create"
										r.operationGroup = ""
										r.pathPattern = "/workspaces/{slug}/invitations"
										r.args = args
										r.count = 1
								...
								case '/': // Prefix: "/"
									...
									if len(elem) == 0 {
										...
										switch method {
										case "DELETE":
											r.name = SiteInvitationsDeleteOperation
											r.summary = ""
											r.operationID = "SiteInvitations_delete"
											r.operationGroup = ""
											r.pathPattern = "/workspaces/{slug}/invitations/{id}"
											r.args = args
											r.count = 2
											return r, true
										default:
						...
						case 'm': // Prefix: "memberships"
							...
							if len(elem) == 0 {
								switch method {
								case "GET":
									r.name = SiteMembershipsListOperation
									r.summary = ""
									r.operationID = "SiteMemberships_list"
									r.operationGroup = ""
									r.pathPattern = "/workspaces/{slug}/memberships"
									r.args = args
									r.count = 1
									return r, true
								default:
							...
							case '/': // Prefix: "/"
								...
								if len(elem) == 0 {
									...
									case "DELETE":
										...
										r.summary = ""
										r.operationID = "SiteMemberships_delete"
										r.operationGroup = ""
										r.pathPattern = "/workspaces/{slug}/memberships/{id}"
										r.args = args
										r.count = 2
										return r, true
									case "PUT":
										r.name = SiteMembershipsUpdateOperation
										r.summary = ""
										r.operationID = "SiteMemberships_update"
										r.operationGroup = ""
										r.pathPattern = "/workspaces/{slug}/memberships/{id}"
										r.args = args
										r.count = 2
